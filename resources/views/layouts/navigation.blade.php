    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16 items-center">
            ...
            <div class="flex items-center space-x-3">
                ...
                <span class="font-semibold text-lg tracking-wide">{{ env('APP_NAME', 'Job Portal') }}</span>
            </div>
            ...
            <div class="-me-2 flex items-center sm:hidden">
                <button @click="open = ! open" class="p-2 rounded-md hover:bg-indigo-800 focus:outline-none transition">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            <div class="px-4">
                ...
                <div class="text-xs text-gray-400 mt-1">Role: {{ Auth::user()->role }}</div>
            </div>
